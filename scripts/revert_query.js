...
const target1 = `    // 3. SNSプロフィールからキャストIDを取得 + is_admin = true のプロフィールも取得
...
const replace1 = `    // 3. SNSプロフィールからキャストIDを取得
...
if (content.includes(t1)) {
    ...
    console.log('Success reverting [prefecture]/page.tsx query');
} else {
